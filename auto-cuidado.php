    ...
    <div class="desktop-container">
        ...
        <aside class="sidebar">
            <div class="logo-container">
                <img src="img/FirmeApoio.png" alt="FIRME APOIO" class="logo">
                <h1>FIRME APOIO</h1>
            </div>
            ...
            <div class="user-section">
                <div class="user-profile">
                    <img src="img/user-avatar.png" alt="Usuário" class="user-avatar">
                    <div class="user-info">
                        <span class="user-name">Rosimeire Webber</span>
        ...
        <main class="main-content">
            ...
            <nav class="top-menu">
                <div class="menu-container">
                    <a href="auto-cuidado.html" class="menu-btn active">Análise</a>
                    <a href="habitos.php" class="menu-btn">Hábitos</a>
                    <a href="exercicios.html" class="menu-btn">Exercícios</a>
                </div>
            </nav>
